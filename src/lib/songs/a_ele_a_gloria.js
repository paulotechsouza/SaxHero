/**
 * A Ele a Glória
 * Hinário — BPM 65 — Dificuldade 3
 *
 * Tom de concerto para saxofone alto (escrita → concerto: +9 semitons):
...
// C3: Si♩  Do♩. Do♪                     (1 + 1,5 + 0,5 + 1 pausa = 4 tempos)
...
// C4: Si♩ Do♩. Re♪  (1 + 1,5 + 0,5 + 1 pausa = 4 tempos)
// C5: Mi♩ Re♩ Do♩ Re♩
// C6: Do♩ Si♩ Do𝅗𝅥
function _refrao1(s) {
  return [
